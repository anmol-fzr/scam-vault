...
import { contactSchema } from '@/schema/other.schema';
import { FormInput, FormTextarea } from '../form';
import { Form } from '../ui/form';
import { faker } from '@faker-js/faker';

const fNamePlaceholder = faker.person.firstName()
const lNamePlaceholder = faker.person.lastName()
const emailPlaceholder = faker.internet.email({ firstName: fNamePlaceholder, lastName: lNamePlaceholder })
const namePlaceholder = fNamePlaceholder + " " + lNamePlaceholder
...
export function ContactUs() {
  ...
  return (
    <section className="bg-background relative w-full overflow-hidden py-16 md:py-24 " id="contact-us">
      <div
        className="absolute bottom-0 left-0 h-[500px] w-[500px] rounded-full opacity-20 blur-[120px]"
        style={{
          background: `radial-gradient(circle at center, #e60a64, transparent 70%)`,
        }}
      />
      <div
        className="absolute right-0 top-0 h-[300px] w-[300px] rounded-full opacity-10 blur-[100px]"
        style={{
          background: `radial-gradient(circle at center, #e60a64, transparent 70%)`,
        }}
      />
              ...
              <Form {...form}>
                ...
                >
                  ...
                  <FormTextarea
                    ...
                    placeholder=''
                  />
                  <Button type="submit" className="mr-0 ml-auto w-full font-semibold">Send Message</Button>
                </motion.form>
              </Form>
            ...
            >
              <div className="flex flex-col items-center justify-center overflow-hidden">
                <article className="relative mx-auto h-[350px] min-h-60 max-w-[450px] overflow-hidden rounded-3xl border bg-gradient-to-b from-[#e60a64] to-[#e60a64]/5 p-6 text-3xl tracking-tight text-white md:h-[450px] md:min-h-80 md:p-8 md:text-4xl md:leading-[1.05] lg:text-5xl">
                  Edge distributed Highly Scalable Serverless API
