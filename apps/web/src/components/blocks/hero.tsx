...
export function Hero() {
  ...
  return (
    <div className="bg-background relative w-full overflow-hidden h-screen flex items-center max-w-screen">
      {/* Background gradient */}
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 sm:px-6 lg:px-8 lg:py-32">
        <div className="mx-auto max-w-5xl">
          ...
          >
            Track and share scams with an open, developer-friendly API.
          </motion.h1>
          ...
          >
            Build safer apps and empower users with trusted fraud intelligence.
          </motion.p>
          ...
          >
            <Button
              ...
              asChild
            >
              <Link to={isLogin ? "/dashboard" : "/auth/login"}>
            ...
            <Button
              ...
              asChild
            >
              <a href="https://github.com/anmol-fzr/scam-vault" target='_blank'>
          ...
          >
            ...
            <div className="border-border/40 bg-background/80 hover:scale-150 transition-all duration-300 absolute right-12 -bottom-6 h-10 w-10 rounded-lg border p-2 shadow-lg backdrop-blur-md">
